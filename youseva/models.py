...
class Currency(models.Model):
    ...
    currency_format = models.CharField(max_length=30, blank=True, null=True)
    symbol_direction = models.CharField(max_length=30, blank=True, null=True)
...
class Language(models.Model):
    ...
    text_editor_lang = models.CharField(max_length=10, blank=True, null=True)
...
class ProductSetting(models.Model):
    ...
    digital_allowed_file_extensions = models.CharField(max_length=500, blank=True, null=True)
    sitemap_frequency = models.CharField(max_length=30, blank=True, null=True)
    sitemap_last_modification = models.CharField(max_length=30, blank=True, null=True)
    sitemap_priority = models.CharField(max_length=30, blank=True, null=True)
